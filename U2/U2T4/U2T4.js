...
//let aviso = prompt("¿Está seguro de que quiere hacer esto?");

//if (aviso == "si") {
//    alert("En este caso el usuario introdujo Sí")
//} else {
...
// let PI = 3.14;
// let r = prompt("introduce el radio de la circunferencia de la base en cm")
// let h = prompt("introduce la altura en cm")
